...
public class TlsConfigurationTest {
  ...
  public void sslV3Only() throws Exception {
    ...
    try {
      ...
      assertEnabledProtcols(compatibleSocket, "SSLv3");
    } finally {
  ...
  public void useDefault() throws Exception {
    ...
    try {
      ...
      assertEnabledProtcols(socket, defaultProtocols);
    } finally {
      socket.close();
    }
  ...
  private static void assertEnabledProtcols(SSLSocket socket, String... required) {
