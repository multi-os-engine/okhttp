...
public abstract class DelegatingSSLSocket extends SSLSocket {
  ...
  @Override public void onBind(InetAddress localAddress, int localPort) {
    delegate.onBind(localAddress, localPort);
  }
  ...
  @Override public void onConnect(InetAddress remoteAddress, int remotePort) {
    delegate.onConnect(remoteAddress, remotePort);
  }
  ...
  @Override public FileDescriptor getFileDescriptor$() {
