...
public class HttpHandler extends URLStreamHandler {
    ...
    private static final CleartextPermittedURLFilter CLEARTEXT_FILTER =
            new CleartextPermittedURLFilter();
    ...
    public static OkUrlFactory createHttpOkUrlFactory(Proxy proxy) {
        ...
        // Filter for hosts that are not permitted by NetworkSecurityPolicy in cleartext http.
    ...
    private static final class CleartextPermittedURLFilter implements URLFilter {
        @Override
